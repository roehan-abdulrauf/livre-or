...
<body>
    <header>
        ...
        <section class="head">
            <div class="head1">
                <h1 class="h1">N’ayez plus peur des travaux </h1>
            ...
            <div>
                <img class="img" src="https://zupimages.net/up/21/48/pp4x.jpeg" alt="" />
            </div>
        </section>
    </header>
    <main>
        ...
        <section class="page-index">
            ...
            <div class="heade">
                <div>
                    ...
                    <h3 class="h3">Un service clé en main pour des travaux de qualité.</h3>
                ...
                <div>
                    ...
                    <h3 class="h3">Idéal pour vous réconcilier avec les travaux !</h3>
    ...
    <footer>
        <div class="footer">
            ...
            <div>
                <p class="foot copyright">Copyright©2021 Parede. Tous droits réservés.</p>
            </div>
    </footer>
</body>
